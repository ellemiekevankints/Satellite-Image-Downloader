...
output = [[filename[0], xpos[0], ypos[0], zpos[0], xrot[0], yrot[0], zrot[0], xfov[0], yfov[0], foc[0], xsize[0], ysize[0], str(timestamp[0]), xcount[0], ycount[0]],
          [filename[1], xpos[1], ypos[1], zpos[1], xrot[1], yrot[1], zrot[1], xfov[1], yfov[1], foc[1], xsize[1], ysize[1], str(timestamp[1]), xcount[1], ycount[1]]]
